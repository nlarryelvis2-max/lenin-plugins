...
может создавать компании и самостоятельные проекты, назначать владельцев и
участников, выпускать приглашения, читать проектные командные чаты и писать в
них. Модель намеренно состоит только из компаний и проектов — скрытых
«подпроектов» и наследования в owner-контракте нет. Отдельные команды читают
