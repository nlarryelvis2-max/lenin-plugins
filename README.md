...
просмотра пользователей и проектов, создания постоянных participant-аккаунтов
без проектов и управления проектными доступами. Обычный клиентский токен
`project:collaborate` этих инструментов не открывает.
