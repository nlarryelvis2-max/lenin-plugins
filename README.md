...
фильтруемого списка пользователей, просмотра логина, статуса, проектных grants,
наличия пароля и состояния Uplink, создания participant-аккаунтов, управления
проектными доступами и статусом аккаунта. Проект можно создать корневым или
дочерним, настроить наследование участников и материалов, а прямых участников
назначать отдельно в каждом проекте. Отдельные команды читают личный
контекст и project-scoped переписку выбранного пользователя с обязательной
причиной в admin audit.
