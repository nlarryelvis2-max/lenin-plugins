...
Реализация: «как hook запиши, что нужно читать
...
def main():
    ...
    # не с длиной). Срыв-режим = поток без структуры.
    ...
    directive = (
        ...
        "3. ПСИХО-АСПЕКТЫ: что здесь может откликаться у владельца — паттерн, перенос, скрытая динамика,\n"
